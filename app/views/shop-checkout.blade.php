...
@section('subtotals')
	...
	@else
		<h4>Subtotal: <span class="subtotal">0 VND</span></h4>
	@endif
@stop
	...
	@else
	    ...
	    <p>
	        ...
	        <span class="custom-dropdown">
	            ...
	            <select id="country1" name="country1" class="custom-dropdown-select">
	    ...
	    <p>
	        ...
	        Company name<br />
	        <input type="text" id="company_name1" name="company_name1" />
	        ...
	        <div class="right">
	            ...
	            <div class="padding-right">
	                ...
	                <p>
	                    ...
	                    <br />
	                    <input type="text" id="address_detail1" name="address_detail1" placeholder="Apartment, suite, unit etc. (optional)" />
	    ...
	    <p>
	        ...
	        Town / City<br />
	        <input type="text" id="town_city1" name="town_city1" placeholder="Town / City" />
	        ...
	        <div class="left">
	            ...
	            <div class="padding-left">
	                ...
	                <p>
	                    ...
	                    County<br />
	                    <input type="text" id="state_country1" name="state_country1" placeholder="State / County" />
	        ...
	        <div class="right">
	            ...
	            <div class="padding-right">
	                ...
	                <p>
	                    ...
	                    Postcode<br />
	                    <input type="text" id="postcode1" name="postcode1" placeholder="Postcode / Zip" />
